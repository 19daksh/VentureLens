        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-xs space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 border-t border-slate-100">
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
              <Eye className="w-5 h-5 text-indigo-600 mb-2" />
              <h3 className="text-xs font-bold text-slate-900">Radical Clarity</h3>
              <p className="text-[11px] text-slate-500 mt-1">We highlight fatal flaws and operational risks directly rather than sugarcoating them.</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
              <ShieldCheck className="w-5 h-5 text-indigo-600 mb-2" />
              <h3 className="text-xs font-bold text-slate-900">Founder Sovereignty</h3>
              <p className="text-[11px] text-slate-500 mt-1">Your ideas belong strictly to you. With PostgreSQL RLS, your data remains 100% private.</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
              <Sparkles className="w-5 h-5 text-indigo-600 mb-2" />
              <h3 className="text-xs font-bold text-slate-900">Pragmatic Execution</h3>
              <p className="text-[11px] text-slate-500 mt-1">Every evaluation translates directly into must-have MVP features and immediate validation actions.</p>
            </div>
          </div>
        </div>
