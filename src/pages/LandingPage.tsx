        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-14 pt-10 border-t border-slate-800/80 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <p className="text-xs text-slate-300 mt-1 font-medium">Evaluation Framework</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl font-extrabold text-indigo-300">&lt; 45 Sec</p>
              <p className="text-xs text-slate-300 mt-1 font-medium">Deep Gemini Analysis</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl font-extrabold text-white">TAM / SAM</p>
              <p className="text-xs text-slate-300 mt-1 font-medium">Transparent Sizing</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl font-extrabold text-emerald-400">100% RLS</p>
              <p className="text-xs text-slate-300 mt-1 font-medium">Isolated User Storage</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200 dark:border-slate-700">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500 dark:text-slate-300">Commercial EV Fleet</span>
                </div>
              ...
              <div className="flex items-center gap-3">
                <div className="text-right hidden sm:block">
                  <span className="text-xs font-semibold text-slate-500 dark:text-slate-300 uppercase tracking-wide block">
                    Validation Verdict
                  </span>
            ...
            <div className="pt-6">
              {activeTab === 'market' && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white dark:bg-slate-800/90 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
                    <p className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Total Addressable Market</p>
                    <p className="text-2xl font-extrabold text-slate-900 dark:text-white mt-1">$18.4 Billion</p>
                    <p className="text-xs text-slate-600 dark:text-slate-300 mt-2">Global commercial fleet telematics and depot charging market by 2030.</p>
                  </div>
                  <div className="bg-white dark:bg-slate-800/90 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
                    <p className="text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider">Serviceable Addressable</p>
                    <p className="text-2xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-1">$3.8 Billion</p>
                    <p className="text-xs text-slate-600 dark:text-slate-300 mt-2">Class 3-6 commercial delivery van fleets in North America & Western Europe.</p>
                  </div>
                  <div className="bg-white dark:bg-slate-800/90 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
                    <p className="text-xs font-bold text-emerald-700 dark:text-emerald-300 uppercase tracking-wider">Early Obtainable (Year 1-3)</p>
                    <p className="text-2xl font-extrabold text-emerald-600 dark:text-emerald-400 mt-1">$210 Million</p>
                    <p className="text-xs text-slate-600 dark:text-slate-300 mt-2">Amazon DSP contractors and municipal express logistics depots.</p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'economics' && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white dark:bg-slate-800/90 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                    <p className="text-xs font-bold text-slate-500 dark:text-slate-300">Recommended Model</p>
                  ...
                  <div className="bg-white dark:bg-slate-800/90 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                    <p className="text-xs font-bold text-slate-500 dark:text-slate-300">LTV : CAC Target</p>
                ...
                <div className="space-y-3">
                  <div className="p-3.5 bg-white dark:bg-slate-800/90 rounded-lg border border-slate-200 dark:border-slate-700 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5">Ingest OBD-II CAN-bus packets and benchmark battery state-of-health variance on 20 pilot delivery vans.</p>
                    </div>
                  </div>
                  <div className="p-3.5 bg-white dark:bg-slate-800/90 rounded-lg border border-slate-200 dark:border-slate-700 flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 text-indigo-600 dark:text-indigo-400 shrink-0 mt-0.5" />
                    <div>
                      ...
                      <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5">Connect OpenADR protocol to schedule overnight depot charging away from 4 PM–9 PM utility surge rates.</p>
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs relative">
              ...
              <div className="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-700/60 flex items-center justify-center font-bold text-sm mb-4">
                1
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((cat, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 rounded-xl border border-slate-200 dark:border-slate-700/80 bg-slate-50/70 dark:bg-slate-800/70 hover:bg-white dark:hover:bg-slate-800 hover:border-indigo-200 dark:hover:border-indigo-500/40 transition-all shadow-xs group"
                >
                  <div className="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-700/60 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                    <Icon className="w-5 h-5" />
                  </div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white">{cat.title}</h3>
                  <p className="text-xs text-slate-600 dark:text-slate-300 mt-2 leading-relaxed">{cat.desc}</p>
                  <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-700/80 flex items-center gap-1.5 text-[11px] font-semibold text-indigo-600 dark:text-indigo-300">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-slate-900 p-7 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col transition-colors">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">Explorer</span>
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-slate-900 dark:text-white">$0</span>
                <span className="text-xs text-slate-500 dark:text-slate-300">/ forever</span>
              </div>
              <p className="text-xs text-slate-600 dark:text-slate-300 mt-2">Test your initial concepts with foundational validation.</p>
              ...
              <Link
                to="/signup"
                className="mt-8 block text-center py-2.5 rounded-lg border border-slate-300 dark:border-slate-700 text-xs font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
              >
                Get Started Free
              </Link>
            </div>
            ...
            {/* Studio */}
            <div className="bg-white dark:bg-slate-900 p-7 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col transition-colors">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">Venture Studio</span>
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-slate-900 dark:text-white">$99</span>
                <span className="text-xs text-slate-500 dark:text-slate-300">/ month</span>
              </div>
              <p className="text-xs text-slate-600 dark:text-slate-300 mt-2">For incubators, accelerators, and startup studios.</p>
