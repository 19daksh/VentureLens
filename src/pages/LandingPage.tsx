      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mt-3 font-['Space_Grotesk',sans-serif]">
          ...
          <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">Commercial EV Fleet</span>
                </div>
              ...
              <div className="flex items-center gap-3">
                <div className="text-right hidden sm:block">
                  ...
                  <span className="text-sm font-bold text-emerald-600">Strong Build Signal</span>
                </div>
            ...
            <div className="flex items-center gap-2 mt-6 overflow-x-auto pb-2 border-b border-slate-200">
              {[
            ...
            <div className="pt-6">
              {activeTab === 'market' && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Total Addressable Market</p>
                    <p className="text-2xl font-extrabold text-slate-900 mt-1">$18.4 Billion</p>
                    <p className="text-xs text-slate-500 mt-2">Global commercial fleet telematics and depot charging market by 2030.</p>
                  </div>
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Serviceable Addressable</p>
                    <p className="text-2xl font-extrabold text-indigo-600 mt-1">$3.8 Billion</p>
                    <p className="text-xs text-slate-500 mt-2">Class 3-6 commercial delivery van fleets in North America & Western Europe.</p>
                  </div>
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Early Obtainable (Year 1-3)</p>
                    <p className="text-2xl font-extrabold text-emerald-600 mt-1">$210 Million</p>
                    <p className="text-xs text-slate-500 mt-2">Amazon DSP contractors and municipal express logistics depots.</p>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-xl border border-slate-200">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-bold text-slate-900">Incumbent: Geotab & Samsara</h4>
                      <span className="text-xs font-semibold px-2 py-0.5 rounded bg-amber-50 text-amber-700">Market Leader</span>
                    </div>
              ...
              {activeTab === 'economics' && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-xl border border-slate-200">
                    <p className="text-xs font-bold text-slate-500">Recommended Model</p>
                    <p className="text-base font-bold text-slate-900 mt-1">$99 - $149 / vehicle / month</p>
                    <p className="text-xs text-slate-600 mt-2">High-retention B2B SaaS with zero churn once wired to depot chargers.</p>
                  </div>
                  <div className="bg-white p-4 rounded-xl border border-slate-200">
                    <p className="text-xs font-bold text-slate-500">LTV : CAC Target</p>
                    <p className="text-base font-bold text-emerald-600 mt-1">6.2 : 1 Ratio</p>
                    <p className="text-xs text-slate-600 mt-2">Payback period under 5 months based on direct downtime cost savings.</p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'mvp' && (
                <div className="space-y-3">
                  <div className="p-3.5 bg-white rounded-lg border border-slate-200 flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 text-indigo-600 shrink-0 mt-0.5" />
                    <div>
                      <span className="text-xs font-bold text-slate-900">Phase 1 (Week 1–6): Telemetry Core & Battery Health Score</span>
                      <p className="text-xs text-slate-500 mt-0.5">Ingest OBD-II CAN-bus packets and benchmark battery state-of-health variance on 20 pilot delivery vans.</p>
                    </div>
                  </div>
                  <div className="p-3.5 bg-white rounded-lg border border-slate-200 flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 text-indigo-600 shrink-0 mt-0.5" />
                    <div>
                      <span className="text-xs font-bold text-slate-900">Phase 2 (Week 7–12): Automated Peak Tariff Avoidance</span>
                      <p className="text-xs text-slate-500 mt-0.5">Connect OpenADR protocol to schedule overnight depot charging away from 4 PM–9 PM utility surge rates.</p>
                    </div>
                  </div>
                </div>
              )}
      ...
      <section className="py-20 bg-slate-50 border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-3 font-['Space_Grotesk',sans-serif]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs relative">
              <span className="text-3xl font-black text-indigo-100 absolute top-4 right-4">01</span>
              <div className="w-10 h-10 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-sm mb-4">
                1
              </div>
              <h3 className="text-base font-bold text-slate-900">Input Concept</h3>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs relative">
              <span className="text-3xl font-black text-indigo-100 absolute top-4 right-4">02</span>
              <div className="w-10 h-10 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-sm mb-4">
                2
              </div>
              <h3 className="text-base font-bold text-slate-900">Gemini Server Analysis</h3>
              <p className="text-xs text-slate-600 mt-2 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs relative">
              <span className="text-3xl font-black text-indigo-100 absolute top-4 right-4">03</span>
              <div className="w-10 h-10 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-sm mb-4">
                3
              </div>
              <h3 className="text-base font-bold text-slate-900">Interactive Dashboard</h3>
              <p className="text-xs text-slate-600 mt-2 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs relative">
              <span className="text-3xl font-black text-indigo-100 absolute top-4 right-4">04</span>
              <div className="w-10 h-10 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-sm mb-4">
                4
              </div>
              <h3 className="text-base font-bold text-slate-900">Compare & Share</h3>
              <p className="text-xs text-slate-600 mt-2 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((cat, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-white hover:border-indigo-200 transition-all shadow-xs group"
                >
                  <div className="w-10 h-10 rounded-lg bg-indigo-100/60 text-indigo-700 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-200/60 flex items-center gap-1.5 text-[11px] font-semibold text-indigo-600">
      ...
      <section className="py-20 bg-slate-50 border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Free */}
            <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-xs flex flex-col">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Explorer</span>
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-slate-900">$0</span>
                <span className="text-xs text-slate-500">/ forever</span>
              </div>
              <p className="text-xs text-slate-500 mt-2">Test your initial concepts with foundational validation.</p>

              <ul className="mt-6 space-y-2.5 text-xs text-slate-600 flex-1">
              ...
              <Link
                to="/signup"
                className="mt-8 block text-center py-2.5 rounded-lg border border-slate-300 text-xs font-bold text-slate-700 hover:bg-slate-50"
              >
                Get Started Free
              </Link>
            </div>
            ...
            <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-xs flex flex-col">
              ...
              <p className="text-xs text-slate-500 mt-2">For incubators, accelerators, and startup studios.</p>
